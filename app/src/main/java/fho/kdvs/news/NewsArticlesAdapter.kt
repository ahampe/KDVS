...
class NewsArticlesAdapter(private val viewModel: SharedViewModel, onClick: (ClickData<NewsEntity>) -> Unit) :
    ...
    class ArticleViewHolder(private val binding: CellArticleBinding, private val viewModel: SharedViewModel) :
