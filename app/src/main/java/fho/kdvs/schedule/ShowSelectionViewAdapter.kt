...
class ShowSelectionViewAdapter(onClick: (ClickData<Pair<Int, String>>) -> Unit) :
    BindingRecyclerViewAdapter<Pair<Int, String>, ShowSelectionViewAdapter.ViewHolder>(onClick, PairIntStringDiffCallback()) {
    ...
    class ViewHolder(private val binding: CellShowSelectionBinding) : BindingViewHolder<Pair<Int, String>>(binding.root) {
