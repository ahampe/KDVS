...
/*    fun allShowsForCurrentQuarterAndYear(): LiveData<List<ShowEntity>> =
        showRepository.allShowsForCurrentQuarterAndYear()
            .sample(500L, TimeUnit.MILLISECONDS, true)
            .toLiveData()*/

    fun getShowAtTime(time: OffsetDateTime): ShowEntity = showRepository.getShowAtTime(time)
