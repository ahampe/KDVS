...
inline val MediaMetadataCompat.flag
    ...
    get() = this.getLong(METADATA_KEY_KDVS_FLAGS).toInt()
...
inline var MediaMetadataCompat.Builder.flag: Int
    ...
    @SuppressLint("WrongConstant")
    set(value) {
        putLong(METADATA_KEY_KDVS_FLAGS, value.toLong())
    }
 ...
 */
const val METADATA_KEY_KDVS_FLAGS = "fho.kdvs.METADATA_KEY_KDVS_FLAGS"