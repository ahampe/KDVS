 ...
 */
class RoomSource(context: Context, source: Uri) : AbstractMusicSource() {
    private var catalog: List<MediaMetadataCompat> = emptyList()

    // TODO Inject DAOs here
...
//            val musicCat = gson.fromJson<JsonCatalog>(reader, JsonCatalog::class.java)
            ...
            val baseUri = catalogUri.toString().removeSuffix(catalogUri.lastPathSegment.orEmpty())
/*
